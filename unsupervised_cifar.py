...
from models.utils import bool_flag, initialize_exp
...
# data
parser.add_argument("--src_lang", type=str, default='vgg', help="Source use vgg on cifar10")
parser.add_argument("--tgt_lang", type=str, default='resnet', help="Target use resnet on cifar10")
...
parser.add_argument("--dis_most_frequent", type=int, default=9000, help="Select embeddings of the k most frequent words for discrimination (0 to disable)")
